...
<div id="main">
	...
	{if $disabledLinks != 0 || $markedLinks != 0}
		{lang}wcf.linkList.moderation.note{/lang}
	{/if}
	...
	{if $categories|count}
		...
		<div class="border {if !$linkListSidebar|isset}content{/if}">
			{if $linkListSidebar|isset}<div class="layout-2">
            	<div class="columnContainer">{/if}
                    <div class="container-1 {if $linkListSidebar|isset}column first{/if}">
                        {if $linkListSidebar|isset}<div class="columnInner">{/if}
                        ...
                        {if $linkListSidebar|isset}</div>{/if}
                    </div>
                    {if $linkListSidebar|isset}
	...
	{if LINKLIST_GENERAL_SHOW_COPYRIGHT}
    	{lang}wcf.linkList.copyright{/lang}
    {/if}
</div>
