...
/**
 * Cleans up old renommee data based on deleted linklist links.
 *
 * @author 	Christoph H.
 ...
 */
class LinkListLinkRenommeeCronjob implements Cronjob {
	/**
	 * @see Cronjob::execute()
	 */
	public function execute($data) {
		// delete renommee data of inexising posts
		$userIDs = '';
		$sql = "SELECT	userID
			FROM	wcf".WCF_N."_user_renommee
			WHERE	objectID NOT IN (SELECT linkID
